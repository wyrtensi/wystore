...
- Раньше приложение определяло код само: скачивало официальный APK целиком, проверяло package name и закреплённую подпись и снимало число с `versionName`. Восемьдесят мегабайт ради шести цифр — механизм убран в 0.2.2 вместе с его настройками.
